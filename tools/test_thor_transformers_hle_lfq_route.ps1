...
$requiredRenderProbeFragments = @(
    ...
    '[string]$sliceResult.markerKind -cne "post-arm"',
    '[string]$sliceResult.armMatch -cne $SliceAfterStartStopMatch',
    '[int]$sliceResult.postArmSlicesCompleted -lt $SliceAfterStartPostMarkerSlices',
    'The PhysX queue startup did not complete its post-marker slices.',
    ...
    'The after-START proof did not capture its RPCSX log.',
    '"Thor Transformers PhysX queue startup timeout:"',
    '"8041090A"',
    '"Thread terminated due to fatal error:"',
    'The after-START proof captured a proven failure marker:',
    '-Name "thor_stop"',
