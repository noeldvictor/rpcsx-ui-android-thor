...
function New-Hle25ccShadowDescBattleStockDown160StrongDismiss600Left1800LongGateCommand {
    $macro = "wait:65000;down:160;wait:900;cross:120;wait:12000;gate_load_target:60000;cross:80;wait:3000;up:80;wait:500;cross:80;wait:90000;shot:load-complete-90s;cross:600;wait:18000;shot:post-load-complete-strongdismiss600-18s;ls_left:1800;wait:12000;shot:left1800-check;wait:45000;shot:left1800-late-check"
...
function New-Hle25ccShadowDescBattleStockDown160StrongDismiss600Left1500LongGateCommand {
    $macro = "wait:65000;down:160;wait:900;cross:120;wait:12000;gate_load_target:60000;cross:80;wait:3000;up:80;wait:500;cross:80;wait:90000;shot:load-complete-90s;cross:600;wait:18000;shot:post-load-complete-strongdismiss600-18s;ls_left:1500;wait:1200;shot:left1500-immediate-check;wait:10800;shot:left1500-check;wait:45000;shot:left1500-late-check"
...
function New-Hle25ccShadowDescBattleStockDown160StrongDismiss600Left1200LongGateCommand {
...
function New-Hle25ccShadowDescBattleStockDown160StrongDismiss600Left1350LongGateCommand {
    $macro = "wait:65000;down:160;wait:900;cross:120;wait:12000;gate_load_target:60000;cross:80;wait:3000;up:80;wait:500;cross:80;wait:90000;shot:load-complete-90s;cross:600;wait:18000;shot:post-load-complete-strongdismiss600-18s;ls_left:1350;wait:1200;shot:left1350-immediate-check;wait:10800;shot:left1350-check;wait:45000;shot:left1350-late-check"
...
function New-Hle25ccShadowDescBattleStockDown160StrongDismiss600Left1275LongGateCommand {
    $macro = "wait:65000;down:160;wait:900;cross:120;wait:12000;gate_load_target:60000;cross:80;wait:3000;up:80;wait:500;cross:80;wait:90000;shot:load-complete-90s;cross:600;wait:18000;shot:post-load-complete-strongdismiss600-18s;ls_left:1275;wait:1200;shot:left1275-immediate-check;wait:10800;shot:left1275-check;wait:45000;shot:left1275-late-check"
...
function New-Hle25ccShadowDescBattleStockDown160StrongDismiss600Left1312LongGateCommand {
    $macro = "wait:65000;down:160;wait:900;cross:120;wait:12000;gate_load_target:60000;cross:80;wait:3000;up:80;wait:500;cross:80;wait:90000;shot:load-complete-90s;cross:600;wait:18000;shot:post-load-complete-strongdismiss600-18s;ls_left:1312;wait:1200;shot:left1312-immediate-check;wait:10800;shot:left1312-check;wait:45000;shot:left1312-late-check"
...
function New-Hle25ccShadowDescBattleStockDown160StrongDismiss600Left1331LongGateCommand {
    $macro = "wait:65000;down:160;wait:900;cross:120;wait:12000;gate_load_target:60000;cross:80;wait:3000;up:80;wait:500;cross:80;wait:90000;shot:load-complete-90s;cross:600;wait:18000;shot:post-load-complete-strongdismiss600-18s;ls_left:1331;wait:1200;shot:left1331-immediate-check;wait:10800;shot:left1331-check;wait:45000;shot:left1331-late-check"
...
function New-Hle25ccShadowDescBattleStockDown160StrongDismiss600Left1321LongGateCommand {
    $macro = "wait:65000;down:160;wait:900;cross:120;wait:12000;gate_load_target:60000;cross:80;wait:3000;up:80;wait:500;cross:80;wait:90000;shot:load-complete-90s;cross:600;wait:18000;shot:post-load-complete-strongdismiss600-18s;ls_left:1321;wait:1200;shot:left1321-immediate-check;wait:10800;shot:left1321-check;wait:45000;shot:left1321-late-check"
...
function New-Hle25ccShadowDescBattleStockDown160StrongDismiss600Left1316LongGateCommand {
    $macro = "wait:65000;down:160;wait:900;cross:120;wait:12000;gate_load_target:60000;cross:80;wait:3000;up:80;wait:500;cross:80;wait:90000;shot:load-complete-90s;cross:600;wait:18000;shot:post-load-complete-strongdismiss600-18s;ls_left:1316;wait:1200;shot:left1316-immediate-check;wait:10800;shot:left1316-check;wait:45000;shot:left1316-late-check"
...
function New-Hle25ccShadowDescBattleStockDown160StrongDismiss600Left1318LongGateCommand {
    $macro = "wait:65000;down:160;wait:900;cross:120;wait:12000;gate_load_target:60000;cross:80;wait:3000;up:80;wait:500;cross:80;wait:90000;shot:load-complete-90s;cross:600;wait:18000;shot:post-load-complete-strongdismiss600-18s;ls_left:1318;wait:1200;shot:left1318-immediate-check;wait:10800;shot:left1318-check;wait:45000;shot:left1318-late-check"
...
function New-Hle25ccShadowDescBattleStockDown160StrongDismiss600Left1317LongGateCommand {
    $macro = "wait:65000;down:160;wait:900;cross:120;wait:12000;gate_load_target:60000;cross:80;wait:3000;up:80;wait:500;cross:80;wait:90000;shot:load-complete-90s;cross:600;wait:18000;shot:post-load-complete-strongdismiss600-18s;ls_left:1317;wait:1200;shot:left1317-immediate-check;wait:10800;shot:left1317-check;wait:45000;shot:left1317-late-check"
...
function New-Hle25ccShadowDescBattleStockDown160StrongDismiss600Left1317ReproofAfterDown120FatalCommand {
    $macro = "wait:65000;down:160;wait:900;cross:120;wait:12000;gate_load_target:60000;cross:80;wait:3000;up:80;wait:500;cross:80;wait:90000;shot:load-complete-90s;cross:600;wait:18000;shot:post-load-complete-strongdismiss600-18s;ls_left:1317;wait:1200;shot:left1317-reproof-immediate-check;wait:10800;shot:left1317-reproof-check;wait:45000;shot:left1317-reproof-late-check"
...
function New-Hle25ccShadowDescBattleStockDown160StrongDismiss600Left1316Down120LongGateCommand {
    $macro = "wait:65000;down:160;wait:900;cross:120;wait:12000;gate_load_target:60000;cross:80;wait:3000;up:80;wait:500;cross:80;wait:90000;shot:load-complete-90s;cross:600;wait:18000;shot:post-load-complete-strongdismiss600-18s;ls_left:1316;wait:1200;shot:left1316-immediate-check;ls_down:120;wait:1200;shot:left1316-down120-immediate-check;wait:10800;shot:left1316-down120-check;wait:45000;shot:left1316-down120-late-check"
...
function New-Hle25ccShadowDescBattleStockDown160StrongDismiss600Left1316Down60LongGateCommand {
    $macro = "wait:65000;down:160;wait:900;cross:120;wait:12000;gate_load_target:60000;cross:80;wait:3000;up:80;wait:500;cross:80;wait:90000;shot:load-complete-90s;cross:600;wait:18000;shot:post-load-complete-strongdismiss600-18s;ls_left:1316;wait:1200;shot:left1316-immediate-check;ls_down:60;wait:1200;shot:left1316-down60-immediate-check;wait:10800;shot:left1316-down60-check;wait:45000;shot:left1316-down60-late-check"
...
function New-Hle25ccShadowDescBattleStockDown160StrongDismiss600NoMoveDoubleDismissLongGateCommand {
    $macro = "wait:65000;down:160;wait:900;cross:120;wait:12000;gate_load_target:60000;cross:80;wait:3000;up:80;wait:500;cross:80;wait:90000;shot:load-complete-90s;cross:600;wait:18000;shot:post-load-complete-strongdismiss600-18s;cross:600;wait:18000;shot:post-load-complete-second-strongdismiss600-18s;wait:45000;shot:double-strongdismiss600-late-check;wait:45000;shot:double-strongdismiss600-very-late-check"
    return ".\tools\eternal_sonata_speed_sprint.ps1 -Action WindowsScene -Scene field -Label cpu4-hle-25cc-shadow-desc-battle-stock-down160-strongdismiss600-nomove-double-dismiss-longgate-diagnostic -WindowsInputBackend PadApi -WindowsGameScreen 1 -WindowsCpuAffinityMask 0x0F -WindowsFrameLimit 240 -WindowsVblankRate 240 -EternalSonataGpuProbe Profile -WindowsVisualGate CleanAfterField -WindowsVisualGateFieldSeconds 300 -InputMacro `"$macro`" -MaxSeconds 330 -ScreenshotEverySeconds 20 -ScreenshotStartSeconds 170 -ScreenshotMaxCount 10 -HostSampleSeconds 1 -HostSampleEverySeconds 30"
}
...
function New-Hle25ccShadowDescBattleStockDown160StrongDismiss600TargetReproofAfterLeft1200DebugSaveCommand {
    $macro = "wait:65000;down:160;wait:900;cross:120;wait:12000;gate_load_target:60000;shot:path-target-reproof-after-left1200-debug-save"
...
function New-Hle25ccShadowDescBattleStockDown160StrongDismiss600TargetReproofAfterLeft1317DebugSaveCommand {
    $macro = "wait:65000;down:160;wait:900;cross:120;wait:12000;gate_load_target:60000;shot:path-target-reproof-after-left1317-debug-save"
...
function New-Hle25ccShadowDescBattleStockDown160StrongDismiss600SaveListInventoryAfterPregateDebugSaveCommand {
    $macro = "wait:65000;shot:title-settle-before-inventory;down:160;wait:900;shot:title-after-down160-inventory;cross:120;wait:60000;shot:load-list-initial-after60;down:120;wait:900;shot:load-list-after-down1;down:120;wait:900;shot:load-list-after-down2;down:120;wait:900;shot:load-list-after-down3;down:120;wait:900;shot:load-list-after-down4;down:120;wait:900;shot:load-list-after-down5;down:120;wait:900;shot:load-list-after-down6"
...
$allRunNames = @(Get-ChildItem -LiteralPath $RunRoot -Directory |
    Where-Object { $_.Name -notlike "_*" } |
    Select-Object -ExpandProperty Name)
$historicalHle25ccShadowDescBattleStockDown160StrongDismiss600LeftOnlyLadderPinned =
    @($allRunNames | Where-Object { $_ -like "*battle-stock-down160-strongdismiss600-left1312-longgate-diagnostic-windows" }).Count -gt 0 -and
    @($allRunNames | Where-Object { $_ -like "*battle-stock-down160-strongdismiss600-left1331-longgate-diagnostic-windows" }).Count -gt 0 -and
    @($allRunNames | Where-Object { $_ -like "*battle-stock-down160-strongdismiss600-left1321-longgate-diagnostic-windows" }).Count -gt 0 -and
    @($allRunNames | Where-Object { $_ -like "*battle-stock-down160-strongdismiss600-left1316-longgate-diagnostic-windows" }).Count -gt 0 -and
    @($allRunNames | Where-Object { $_ -like "*battle-stock-down160-strongdismiss600-left1318-longgate-diagnostic-windows" }).Count -gt 0 -and
    @($allRunNames | Where-Object { $_ -like "*battle-stock-down160-strongdismiss600-left1317-longgate-diagnostic-windows" }).Count -gt 0
...
$latestHle25ccVerifierRouteUnsafe = $false
...
$latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1800ProcessExit = $false
$latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1500PreGateFatal = $false
$latestHle25ccShadowDescBattleStockDown160StrongDismiss600TargetReproofAfterLeft1500FatalPass = $false
...
$latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1275FieldPassWithHistoricalPinnedLadder = $false
...
$latestHle25ccShadowDescBattleStockDown160StrongDismiss600NoMoveDoubleDismissFieldPrompt = $false
...
if ($latestRun) {
    ...
    $latestHle25ccVerifierRouteUnsafe =
        $latestRun.Decision -eq "failed-visual-gate" -and
        $latestText -like "*25cc*" -and
        ($latestCutsceneOrNonfield -or $latestBlackOverlay)
    ...
    $latestCleanHle25ccShadowField =
        $latestRun.Decision -eq "valid-field-triage" -and
        $latestText -like "*25cc*" -and
        $latestText -notlike "*battle-stock*" -and
    ...
    $latestHle25ccShadowDescBattleFatal =
        ...
        $latestText -like "*shadow-desc*" -and
        $latestText -like "*battle*" -and
        $latestText -notlike "*battle-stock*"
    ...
    $latestHle25ccShadowDescBattleStockDown160StrongDismissLeft1200FieldPass =
        ...
        $latestText -like "*shadow-desc*" -and
        $latestText -like "*battle-stock-down160-strongdismiss-left1200*"
    $latestHle25ccShadowDescBattleStockDown160StrongDismissLeft1800LoadCompleteStuck =
        $latestRun.Decision -eq "failed-visual-gate" -and
        $latestRun.LoadTarget -and
        $latestRun.LoadTarget.Status -eq "PATH_TO_TENUTO_PRESENT" -and
        $latestRun.Visual.PrimarySmallClass -eq "wrong-window-or-other-small-png" -and
    ...
    $latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1200DebugSaveTarget =
        $latestLoadTargetGateFailure -and
        $latestLoadTargetGateStatus -eq "DEBUG_SAVE_PROLOGUE_PRESENT" -and
        $latestText -like "*25cc*" -and
        $latestText -like "*shadow-desc*" -and
        $latestText -like "*battle-stock-down160-strongdismiss600-left1200*"
    $latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1200CutsceneGate =
        $latestLoadTargetGateFailure -and
        $latestLoadTargetGateStatus -eq "UNKNOWN_LOAD_TARGET" -and
        $latestText -like "*25cc*" -and
        $latestText -like "*shadow-desc*" -and
        $latestText -like "*battle-stock-down160-strongdismiss600-left1200*" -and
        (
            $latestRun.Visual.Status -eq "FIELD_LIKE_PRESENT_WITH_LATER_INVALID_SCREENSHOTS" -or
            (Test-HarnessCutsceneOrNonFieldClass -Class $latestRun.Visual.PrimarySmallClass) -or
            ($latestRun.LoadTarget -and $latestRun.LoadTarget.MarkerText -match "wrong-state|cutscene")
        )
    $latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1200FieldPass =
        $latestRun.Decision -eq "valid-field-triage" -and
        $latestRun.LoadTarget -and
        $latestRun.LoadTarget.Status -eq "PATH_TO_TENUTO_PRESENT" -and
        $latestText -like "*25cc*" -and
        $latestText -like "*shadow-desc*" -and
        $latestText -like "*battle-stock-down160-strongdismiss600-left1200*"
    $latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1350Vm40Corrupt =
        $latestFatal -and
        $latestRun.LoadTarget -and
        $latestRun.LoadTarget.Status -eq "PATH_TO_TENUTO_PRESENT" -and
        $latestRun.Visual.Status -eq "FIELD_LIKE_PRESENT" -and
        $latestText -like "*25cc*" -and
        $latestText -like "*shadow-desc*" -and
    ...
    $latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1275DebugSaveTarget =
        ...
        $latestText -like "*shadow-desc*" -and
        $latestText -like "*battle-stock-down160-strongdismiss600-left1275*"
    $latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1275LoadingOnly =
        -not $latestFatal -and
        $latestRun.Decision -eq "failed-visual-gate" -and
        $latestRun.LoadTarget -and
        $latestRun.LoadTarget.Status -eq "PATH_TO_TENUTO_PRESENT" -and
    ...
    $latestHle25ccShadowDescBattleStockDown160StrongDismiss600NoMoveLoadCompleteStuck =
        -not $latestFatal -and
        $latestRun.Decision -eq "failed-visual-gate" -and
        $latestRun.LoadTarget -and
        $latestRun.LoadTarget.Status -eq "PATH_TO_TENUTO_PRESENT" -and
        ...
        $latestText -like "*25cc*" -and
        $latestText -like "*shadow-desc*" -and
        $latestText -like "*battle-stock-down160-strongdismiss600-nomove-longgate*"
    $latestHle25ccShadowDescBattleStockDown160StrongDismiss600NoMoveDoubleDismissFieldPrompt =
        -not $latestFatal -and
        $latestRun.Decision -eq "valid-field-triage" -and
        $latestRun.LoadTarget -and
        $latestRun.LoadTarget.Status -eq "PATH_TO_TENUTO_PRESENT" -and
    ...
    $latestHle25ccShadowDescBattleStockDown160StrongDismiss600TitleLoadPregateDamagedSaveTarget =
        -not $latestFatal -and
        $latestLoadTargetGateFailure -and
        $latestLoadTargetGateStatus -eq "DAMAGED_SAVE_TARGET" -and
        $latestText -like "*25cc*" -and
    ...
    $latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1275FieldPass =
        -not $latestFatal -and
        $latestRun.Decision -eq "valid-field-triage" -and
        $latestRun.LoadTarget -and
        $latestRun.LoadTarget.Status -eq "PATH_TO_TENUTO_PRESENT" -and
        ...
        $latestText -like "*shadow-desc*" -and
        $latestText -like "*battle-stock-down160-strongdismiss600-left1275*"
    $latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1275FieldPassWithHistoricalPinnedLadder =
        $latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1275FieldPass -and
        $historicalHle25ccShadowDescBattleStockDown160StrongDismiss600LeftOnlyLadderPinned
    $latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1312FieldPass =
        -not $latestFatal -and
        $latestRun.Decision -eq "valid-field-triage" -and
        $latestRun.LoadTarget -and
        $latestRun.LoadTarget.Status -eq "PATH_TO_TENUTO_PRESENT" -and
        $latestText -like "*25cc*" -and
        $latestText -like "*shadow-desc*" -and
        $latestText -like "*battle-stock-down160-strongdismiss600-left1312*"
    $latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1316FieldPass =
        -not $latestFatal -and
        $latestRun.Decision -eq "valid-field-triage" -and
        $latestRun.LoadTarget -and
        $latestRun.LoadTarget.Status -eq "PATH_TO_TENUTO_PRESENT" -and
    ...
    $latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1317ReproofAfterDown120FatalPass =
        -not $latestFatal -and
        $latestRun.Decision -eq "valid-field-triage" -and
        $latestRun.LoadTarget -and
        $latestRun.LoadTarget.Status -eq "PATH_TO_TENUTO_PRESENT" -and
        $latestText -like "*25cc*" -and
        $latestText -like "*shadow-desc*" -and
        $latestText -like "*battle-stock-down160-strongdismiss600-left1317-reproof-after-down120-fatal*"
    $latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1317Down120Vm40Corrupt =
        $latestFatal -and
        $latestRun.LoadTarget -and
        $latestRun.LoadTarget.Status -eq "PATH_TO_TENUTO_PRESENT" -and
        $latestRun.Visual.Status -eq "FIELD_LIKE_PRESENT" -and
    ...
    $latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1331Vm40Corrupt =
        ...
        $latestText -like "*25cc*" -and
        $latestText -like "*shadow-desc*" -and
        $latestText -like "*battle-stock-down160-strongdismiss600-left1331*"
    $latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1321Vm40Corrupt =
        $latestFatal -and
        $latestRun.LoadTarget -and
        $latestRun.LoadTarget.Status -eq "PATH_TO_TENUTO_PRESENT" -and
        $latestRun.Visual.Status -eq "FIELD_LIKE_PRESENT" -and
        $latestText -like "*25cc*" -and
        $latestText -like "*shadow-desc*" -and
        $latestText -like "*battle-stock-down160-strongdismiss600-left1321*"
    $latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1318Vm40Corrupt =
        $latestFatal -and
        $latestRun.LoadTarget -and
        $latestRun.LoadTarget.Status -eq "PATH_TO_TENUTO_PRESENT" -and
        $latestRun.Visual.Status -eq "FIELD_LIKE_PRESENT" -and
        $latestText -like "*25cc*" -and
        $latestText -like "*shadow-desc*" -and
        $latestText -like "*battle-stock-down160-strongdismiss600-left1318*"
    $latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1317DebugSaveTarget =
        -not $latestFatal -and
        $latestLoadTargetGateFailure -and
        $latestLoadTargetGateStatus -eq "DEBUG_SAVE_PROLOGUE_PRESENT" -and
        $latestText -like "*25cc*" -and
    ...
    $latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1800ProcessExit =
        ...
        $latestText -like "*25cc*" -and
        $latestText -like "*shadow-desc*" -and
        $latestText -like "*battle-stock-down160-strongdismiss600-left1800*" -and
        $latestRun.Lab -and
        $latestRun.Lab.ProcessExitedWindowLoss -gt 0
    $latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1500PreGateFatal =
        $latestFatal -and
        $latestLoadTargetGateFailure -and
        $latestLoadTargetGateStatus -eq "UNKNOWN_LOAD_TARGET" -and
        $latestRun.Visual.PrimarySmallClass -eq "black-overlay-small-png" -and
        $latestText -like "*25cc*" -and
        $latestText -like "*shadow-desc*" -and
        $latestText -like "*battle-stock-down160-strongdismiss600-left1500*"
    $latestHle25ccShadowDescBattleStockDown160StrongDismiss600TargetReproofAfterLeft1500FatalPass =
        -not $latestFatal -and
        $latestRun.LoadTarget -and
        $latestRun.LoadTarget.Status -eq "PATH_TO_TENUTO_PRESENT" -and
        $latestText -like "*25cc*" -and
        $latestText -like "*shadow-desc*" -and
        $latestText -like "*battle-stock-down160-strongdismiss600-target-reproof-after-left1500-fatal*"
    $latestHle25ccShadowDescBattleStockDown160StrongDismiss600TargetReproofAfterLeft1200DebugSavePass =
        -not $latestFatal -and
        $latestRun.LoadTarget -and
        $latestRun.LoadTarget.Status -eq "PATH_TO_TENUTO_PRESENT" -and
        $latestText -like "*25cc*" -and
        $latestText -like "*shadow-desc*" -and
        $latestText -like "*battle-stock-down160-strongdismiss600-target-reproof-after-left1200-debug-save*"
    $latestHle25ccShadowDescBattleStockDown160StrongDismiss600TargetReproofAfterLeft1317DebugSavePass =
        -not $latestFatal -and
        $latestRun.LoadTarget -and
        $latestRun.LoadTarget.Status -eq "PATH_TO_TENUTO_PRESENT" -and
        $latestText -like "*25cc*" -and
        $latestText -like "*shadow-desc*" -and
        $latestText -like "*battle-stock-down160-strongdismiss600-target-reproof-after-left1317-debug-save*"
    $latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1500RsxFpcalCorrupt =
        $latestFatal -and
        $latestRun.LoadTarget -and
        $latestRun.LoadTarget.Status -eq "PATH_TO_TENUTO_PRESENT" -and
        $latestRun.Visual.Status -eq "FIELD_LIKE_PRESENT" -and
...
if ($latestLoadTargetGateFailure -and
    ...
    -not $latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1317DebugSaveTarget -and
...
if ($fatalRuns.Count -ge 1) {
    ...
    } elseif ($latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1500PreGateFatal) {
        "Latest strongdismiss600 left1500 attempt never tested movement: it hit a pre-gate black-overlay fatal before save-slot Cross. Re-prove the strongdismiss600 target-only gate before any generic state-aware or movement rerun."
    } elseif ($latestHle25ccShadowDescBattleStockDown160StrongDismiss600TargetReproofAfterLeft1500FatalPass) {
        "Latest strongdismiss600 target-only reproof after the left1500 pre-gate fatal passed PATH_TO_TENUTO_PRESENT and was fatal-clean. Resume the same ls_left:1500 movement proof with an immediate screenshot instead of falling back to generic loader-control."
    } elseif ($latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1500RsxFpcalCorrupt) {
        "Latest strongdismiss600 left1500 reached field, then the post-left branch hit an RSX Unimplemented FP CAL fatal. Shrink the same strongdismiss600 movement rung to ls_left:1200 with immediate screenshots before trying another midpoint."
    } elseif ($latestHle25ccShadowDescBattleStockLoading) {
...
if ($latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1200DebugSaveTarget) {
    Add-AntiPattern -List $antiPatterns -Name "hle-25cc-shadow-desc-battle-stock-down160-strongdismiss600-left1200-debug-save-target" -Severity "blocker" -Evidence "Newest stronger-dismiss left1200 shrink aborted before save-slot Cross because the load-target gate saw DEBUG_SAVE_PROLOGUE_PRESENT in every polling screenshot." -Action "Do not count this as the left1200 movement boundary and do not fall back to generic state-aware routing. Restore or repair the Path-to-Tenuto save target, re-prove PATH_TO_TENUTO_PRESENT with a target-only gate, then retry the same strongdismiss600 left1200 shape only after the save target is correct."
}
if ($latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1200CutsceneGate) {
    Add-AntiPattern -List $antiPatterns -Name "hle-25cc-shadow-desc-battle-stock-down160-strongdismiss600-left1200-title-route-miss-after-target-reproof" -Severity "blocker" -Evidence "Newest stronger-dismiss left1200 movement retry after a passed target-only gate never reached the Load list; the load-target guard saw UNKNOWN/cutscene frames and aborted before save-slot Cross." -Action "Do not count this as a movement boundary and do not rerun the same movement macro. Run the Down160 title-to-Load diagnostic with explicit title/down/cross/pre-gate screenshots before another strongdismiss600 movement retry."
}
if ($latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1800ProcessExit) {
    Add-AntiPattern -List $antiPatterns -Name "hle-25cc-shadow-desc-battle-stock-down160-strongdismiss600-left1800-process-exit" -Severity "route-repair" -Evidence "Newest stronger-dismiss left1800 retry restored PATH_TO_TENUTO_PRESENT and reached clean Path-to-Tenuto field, but RPCS3 exited after ls_left:1800 before left-check screenshots." -Action "Do not fall back to generic state-aware routing and do not count left1800 as movement/battle/speed proof. Keep the strongdismiss600 base, shrink the movement midpoint to ls_left:1500, and capture an immediate post-movement screenshot before verifier, battle, HLE, RSX, GPU, or speed work."
}
if ($latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1500PreGateFatal) {
    Add-AntiPattern -List $antiPatterns -Name "hle-25cc-shadow-desc-battle-stock-down160-strongdismiss600-left1500-pregate-fatal-0x4" -Severity "blocker" -Evidence "Newest stronger-dismiss left1500 attempt black-overlayed before the load-target gate could see a save slot, timed out as UNKNOWN_LOAD_TARGET, and reported a PPU main_thread VM access violation reading 0x4 before save-slot Cross." -Action "Do not count this as movement, do not fall back to generic state-aware macros, and do not start verifier/HLE/RSX/GPU/speed work. Re-prove only the strongdismiss600 Path-to-Tenuto load target, then decide whether the left1500 movement rerun is safe."
}
if ($latestHle25ccShadowDescBattleStockDown160StrongDismiss600TargetReproofAfterLeft1500FatalPass) {
    Add-AntiPattern -List $antiPatterns -Name "hle-25cc-shadow-desc-battle-stock-down160-strongdismiss600-target-reproof-after-left1500-fatal-passed" -Severity "resolved-control" -Evidence "Newest target-only strongdismiss600 reproof after the left1500 fatal passed PATH_TO_TENUTO_PRESENT and had no actionable fatal/access/assertion/device-lost log hit." -Action "Treat this as target health only, not field/movement/speed/GPU proof. Resume the same strongdismiss600 ls_left:1500 movement proof with the immediate post-movement screenshot; do not fall back to generic state-aware or loader-control routes."
}
...
if ($latestHle25ccShadowDescBattleStockDown160StrongDismiss600TargetReproofAfterLeft1317DebugSavePass) {
    Add-AntiPattern -List $antiPatterns -Name "hle-25cc-shadow-desc-battle-stock-down160-strongdismiss600-target-reproof-after-left1317-debug-save-passed" -Severity "resolved-control" -Evidence "Newest target-only strongdismiss600 reproof after the left1317 Debug Save blocker passed PATH_TO_TENUTO_PRESENT and had no actionable fatal/access/assertion/device-lost log hit." -Action "Treat this as target health only, not field/movement/speed/GPU proof. Keep the left1316 clean / left1318 fatal bracket and resume the same strongdismiss600 ls_left:1317 movement proof with immediate post-movement screenshots."
}
...
if ($latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1200FieldPass) {
    Add-AntiPattern -List $antiPatterns -Name "hle-25cc-shadow-desc-battle-stock-down160-strongdismiss600-left1200-field-clean" -Severity "resolved-control" -Evidence ("Newest strongdismiss600 left1200 run proved Path-to-Tenuto field at {0}s, accepted the left1200 pulse, and stayed field-clean through late screenshots." -f $latestRun.Visual.FirstFieldSeconds) -Action "Bank this as the clean lower movement boundary after the left1500 RSX fatal. Try the left1350 midpoint next with immediate screenshots; do not promote verifier, battle, HLE, RSX, GPU, or speed work yet."
}
...
if ($latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1275FieldPassWithHistoricalPinnedLadder) {
    Add-AntiPattern -List $antiPatterns -Name "hle-25cc-shadow-desc-battle-stock-down160-strongdismiss600-left1275-field-clean-after-pinned-ladder" -Severity "resolved-control" -Evidence ("Newest strongdismiss600 left1275 rerun proved Path-to-Tenuto field at {0}s and stayed field-clean, but older durable evidence already pins the left-only ladder through left1312/1331/1321/1316/1318/1317." -f $latestRun.Visual.FirstFieldSeconds) -Action "Do not loop back through historical left1312/1331/1321/1316/1318/1317 midpoint proofs. Keep the left-only bracket pinned and test a new smaller down nudge, left1316-down60, before verifier, battle, HLE, RSX, GPU, or speed work."
}
if ($latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1275FieldPass -and -not $latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1275FieldPassWithHistoricalPinnedLadder) {
    Add-AntiPattern -List $antiPatterns -Name "hle-25cc-shadow-desc-battle-stock-down160-strongdismiss600-left1275-field-clean" -Severity "resolved-control" -Evidence ("Newest strongdismiss600 left1275 run proved Path-to-Tenuto field at {0}s, accepted the left1275 pulse, and stayed field-clean through late screenshots." -f $latestRun.Visual.FirstFieldSeconds) -Action "Bank left1275 as the clean lower movement boundary below the left1350 fatal/corrupt upper boundary. Try the left1312 midpoint with immediate screenshots before verifier, battle, HLE, RSX, GPU, or speed work."
}
if ($latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1312FieldPass) {
    Add-AntiPattern -List $antiPatterns -Name "hle-25cc-shadow-desc-battle-stock-down160-strongdismiss600-left1312-field-clean" -Severity "resolved-control" -Evidence ("Newest strongdismiss600 left1312 run proved Path-to-Tenuto field at {0}s, accepted the left1312 pulse, and stayed field-clean through late screenshots." -f $latestRun.Visual.FirstFieldSeconds) -Action "Bank left1312 as the clean lower movement boundary below the left1350 fatal/corrupt upper boundary. Try the left1331 midpoint with immediate screenshots before verifier, battle, HLE, RSX, GPU, or speed work."
}
...
if ($latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1317ReproofAfterDown120FatalPass) {
    Add-AntiPattern -List $antiPatterns -Name "hle-25cc-shadow-desc-battle-stock-down160-strongdismiss600-left1317-reproof-after-down120-fatal-passed" -Severity "resolved-control" -Evidence ("Plain left1317 reproof after the left1317-down120 fatal passed Path-to-Tenuto field at {0}s, accepted the left1317 pulse, and stayed field-clean through late screenshots with no actionable fatal/access/assertion/device-lost log hit." -f $latestRun.Visual.FirstFieldSeconds) -Action "Bank plain left1317 as clean single-axis movement, but keep left1317-down120 failed and do not repeat that exact combo. Try the lower-bound left1316-down120 diagnostic with immediate screenshots before verifier, HLE, RSX, GPU, speed, or first-battle promotion."
}
...
if ($latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1321Vm40Corrupt) {
    Add-AntiPattern -List $antiPatterns -Name "hle-25cc-shadow-desc-battle-stock-down160-strongdismiss600-left1321-vm40-corrupt-field" -Severity "blocker" -Evidence "Newest strongdismiss600 left1321 run passed PATH_TO_TENUTO_PRESENT and reached a clean pre-movement field, but the immediate and later post-left screenshots showed the RPCS3 likely-crashed overlay with corrupt/frozen field while stderr/RPCS3.log reported a PPU VM access violation at 0x40." -Action "Do not count this as clean movement, speed, first-battle, or GPU migration proof. Keep left1312 as the clean lower boundary and left1321 as the fatal/corrupt upper boundary; try the left1316 midpoint with immediate screenshots before verifier, battle, HLE, RSX, GPU, or speed work."
}
...
if ($latestHle25ccShadowDescBattleStockDown160StrongDismiss600TitleLoadPregateDamagedSaveTarget) {
    Add-AntiPattern -List $antiPatterns -Name "hle-25cc-shadow-desc-battle-stock-down160-strongdismiss600-titleload-pregate-damaged-save-target" -Severity "route-repair" -Evidence "Newest title-to-Load pre-gate diagnostic selected LOAD and reached a stable Load list by 12s, but the selected row was a lower Path-to-Tenuto save with damaged-save rows above it; the gate aborted before slot Cross." -Action "Do not treat this as black-gate timing, movement, speed, or GPU proof. Run the stable Load-list Up-repair target diagnostic and require PATH_TO_TENUTO_PRESENT before any no-movement or movement route."
}
...
$upstream25ccWindowsExeFile = Join-Path $RepoRoot "..\rpcs3-upstream\build-msvc\bin\rpcs3.exe"
$has25ccPayloadModeWindowsExeLinked = $false
if ($has25ccPayloadModeUpstreamPatchApplied -and (Test-Path -LiteralPath $upstream25ccWindowsExeFile -PathType Leaf)) {
    $sourceTimes = @((Get-Item -LiteralPath $upstream25ccSpuThreadFile).LastWriteTimeUtc, (Get-Item -LiteralPath $upstream25ccSysSpuFile).LastWriteTimeUtc)
    $latestSourceTime = ($sourceTimes | Sort-Object -Descending | Select-Object -First 1)
    $exeTime = (Get-Item -LiteralPath $upstream25ccWindowsExeFile).LastWriteTimeUtc
    $has25ccPayloadModeWindowsExeLinked = $exeTime -ge $latestSourceTime
}
$nextAction = if ($currentUpstreamWindowsPromotionGateCleared) {
...
} elseif ($latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1200DebugSaveTarget) {
    "Latest stock Down160 strongdismiss600 left1200 shrink aborted before save-slot Cross on Debug Save / Prologue. Stop movement retries, restore or repair the Path-to-Tenuto save target, and require target-only PATH_TO_TENUTO_PRESENT before re-running that left1200 shape."
} elseif ($latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1200CutsceneGate) {
    "Latest stock Down160 strongdismiss600 left1200 retry after target reproof entered story/cutscene frames before the Load-list gate. Do not rerun movement; run the Down160 title-to-Load diagnostic with explicit screenshots."
} elseif ($latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1800ProcessExit) {
    "Latest stock Down160 strongdismiss600 left1800 retry reached clean Path-to-Tenuto field, then RPCS3 exited before left-check screenshots after ls_left:1800. Keep the restored strongdismiss600 base and shrink to ls_left:1500 with an immediate post-movement screenshot; do not fall back to generic state-aware routing."
} elseif ($latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1500PreGateFatal) {
    "Latest stock Down160 strongdismiss600 left1500 attempt fataled before save-slot Cross while the load-target gate saw only UNKNOWN black-overlay frames. Movement was not tested; re-prove the strongdismiss600 Path-to-Tenuto target only, and do not fall back to generic state-aware routing."
} elseif ($latestHle25ccShadowDescBattleStockDown160StrongDismiss600TargetReproofAfterLeft1500FatalPass) {
    "Latest stock Down160 strongdismiss600 target-only reproof after the left1500 fatal passed PATH_TO_TENUTO_PRESENT and was fatal-clean. Resume the same ls_left:1500 movement proof with the immediate screenshot; do not fall back to generic state-aware or loader-control routes."
} elseif ($latestHle25ccShadowDescBattleStockDown160StrongDismiss600TargetReproofAfterLeft1200DebugSavePass) {
    "Latest stock Down160 strongdismiss600 target-only reproof after the left1200 Debug Save blocker passed PATH_TO_TENUTO_PRESENT and was fatal-clean. Resume the same ls_left:1200 movement proof with immediate screenshots; do not fall back to generic state-aware or loader-control routes."
} elseif ($latestHle25ccShadowDescBattleStockDown160StrongDismiss600TargetReproofAfterLeft1317DebugSavePass) {
    "Latest stock Down160 strongdismiss600 target-only reproof after the left1317 Debug Save blocker passed PATH_TO_TENUTO_PRESENT and was fatal-clean. Keep the left1316 clean / left1318 fatal bracket and retry ls_left:1317 with immediate screenshots."
...
} elseif ($latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1275FieldPassWithHistoricalPinnedLadder) {
    "Latest stock Down160 strongdismiss600 left1275 rerun is field-clean, but older durable evidence already pins the left-only ladder through left1312, left1331, left1321, left1316, left1318, and left1317. Do not rerun those historical midpoint proofs; test a new smaller left1316-down60 nudge with immediate screenshots."
} elseif ($latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1275FieldPass) {
    "Latest stock Down160 strongdismiss600 left1275 movement proof is field-clean after the left1350 VM40/corrupt-field fatal. Bank left1275 as the clean lower boundary and try the left1312 midpoint with immediate screenshots before verifier, battle, HLE, RSX, GPU, or speed work."
} elseif ($latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1312FieldPass) {
...
} elseif ($latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1317ReproofAfterDown120FatalPass) {
...
} elseif ($latestHle25ccShadowDescBattleStockDown160StrongDismiss600TitleLoadPregateDamagedSaveTarget) {
    "Latest stock Down160 strongdismiss600 title-to-Load pre-gate diagnostic selected LOAD, then settled on a damaged lower Path row before any slot Cross. Do not run movement, speed, HLE, or RSX work; run only the stable Load-list Up-repair target diagnostic."
    ...
    "Latest stock Down160 strongdismiss600 save-list inventory shows the initial Load-list position is Save File 01 Path to Tenuto, while Down moves the cursor onto lower rows where the Path preview can stay stale over empty slots. Do not normalize with Down/Up; resume the no-movement long-gate proof from the initial Path row before another movement attempt."
...
} elseif ($latestHle25ccShadowDescBattleStockDown160StrongDismiss600NoMoveDoubleDismissFieldPrompt) {
    "Latest stock Down160 strongdismiss600 double-dismiss proof reached clean Path-to-Tenuto field at the first post-load checkpoint, then the second Cross opened the Save game prompt. Bank it as no-movement field repair only; resume the same base with ls_left:1275 and immediate screenshots before verifier, battle, HLE, RSX, GPU, or speed work."
...
} elseif ($latestHle25ccShadowDescBattleStockDown160StrongDismissLeft1800LoadCompleteStuck) {
    "Latest stock Down160 strong-dismiss left1800 long-gate diagnostic proved the Path-to-Tenuto load target, but never dismissed the Load complete popup. Do not count it as movement; retry the same left1800 long-gate shape once with a stronger single Cross hold before verifier or battle promotion."
} elseif ($latestHle25ccShadowDescBattleStockDown160LeftOnlyProcessExit) {
...
$suggestedCommand = if ($currentUpstreamWindowsPromotionGateCleared) {
    ...
    New-Hle25ccShadowDescBattleStockDown160StrongDismiss600TargetReproofAfterLeft1200DebugSaveCommand
} elseif ($latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1200CutsceneGate) {
    New-StateAwareTitleToLoadDownHoldDiagnosticCommand
} elseif ($latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1800ProcessExit) {
    New-Hle25ccShadowDescBattleStockDown160StrongDismiss600Left1500LongGateCommand
} elseif ($latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1500PreGateFatal) {
    New-Hle25ccShadowDescBattleStockDown160StrongDismiss600TargetReproofAfterLeft1500FatalCommand
} elseif ($latestHle25ccShadowDescBattleStockDown160StrongDismiss600TargetReproofAfterLeft1500FatalPass) {
    New-Hle25ccShadowDescBattleStockDown160StrongDismiss600Left1500LongGateCommand
} elseif ($latestHle25ccShadowDescBattleStockDown160StrongDismiss600TargetReproofAfterLeft1200DebugSavePass) {
    New-Hle25ccShadowDescBattleStockDown160StrongDismiss600Left1200LongGateCommand
    ...
    New-Hle25ccShadowDescBattleStockDown160StrongDismiss600Left1312LongGateCommand
} elseif ($latestHle25ccShadowDescBattleStockDown160StrongDismiss600Left1312FieldPass) {
    ...
    New-Hle25ccShadowDescBattleStockDown160StrongDismiss600Left1800LongGateCommand
} elseif ($latestHle25ccShadowDescBattleStockDown160LeftOnlyProcessExit) {
    ...
    $(if ($has25ccPayloadModeWindowsExeLinked) { ".\tools\eternal_sonata_speed_sprint.ps1 -Action WindowsScene -Scene field -Label cpu4-25cc-counts-route-repair-after-payload-split -WindowsInputBackend PadApi -WindowsGameScreen 1 -WindowsCpuAffinityMask 0x0F -WindowsFrameLimit 240 -WindowsVblankRate 240 -EternalSonataSpuHleVerify Verify25ccShadow -EternalSonataSpuHle25ccShadowPayload Counts -WindowsHostContentionGate ExternalFail -WindowsVisualGate CleanAfterField -WindowsVisualGateFieldSeconds 160 -MaxSeconds 220 -ScreenshotEverySeconds 10 -ScreenshotStartSeconds 110 -ScreenshotMaxCount 12" } elseif ($has25ccPayloadModeUpstreamPatchApplied) { "# Build next: cmake --build ..\rpcs3-upstream\build-msvc --config Release --target rpcs3 ; if MSBuild postdeploy fails after linking rpcs3.exe, proceed only after confirming the exe is newer than the patched sources." } elseif ($has25ccPayloadModePatch) { "# Apply/build next: git -C ..\rpcs3-upstream apply ..\rpcsx-ui-android\spu-contracts\BLUS30161\25cc-shadow-payload-mode-upstream.patch ; then rebuild Windows RPCS3 before counts-mode route repair." } else { ".\tools\summarize_eternal_sonata_25cc_route_safety.ps1" })
} elseif ($latestCutsceneOrNonfield -and $blockFailedNextLoaderControl) {
