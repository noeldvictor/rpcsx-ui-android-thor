...
namespace rsx
{
	...
	void rsx_state::init()
	{
...

		{
			...
			if (rsx::thor_flat_shading_enabled())
			{
				// Only when the shade mode can reach a shader. Otherwise this register costs
				// a vertex AND fragment program re-evaluation for a value nothing reads.
