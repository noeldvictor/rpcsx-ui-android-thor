...
- Current refiner next action: extend the newest valid `loader-control-left200x1` route by exactly one more tiny state-aware left pulse with `CleanAfterField`; keep lane-2 HLE/GPU dry-runs blocked.
