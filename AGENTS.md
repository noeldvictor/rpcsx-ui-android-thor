...
- Current refiner next action: extend the newest valid `loader-control-left200` route by exactly one more tiny state-aware left pulse (`left200x2`) with `CleanAfterField`; keep lane-2 HLE/GPU dry-runs blocked.
