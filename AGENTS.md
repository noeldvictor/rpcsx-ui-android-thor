...
- Current refiner/atlas next action: do not repeat field counterproof or verifier/hash/native-contract reports. Repair/prove first battle under `Verify25ccShadow`; body/skip/GPU modes remain blocked until field, Options/menu, and first-battle visuals are valid.
