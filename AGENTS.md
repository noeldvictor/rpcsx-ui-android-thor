...
- Current refiner next action: back off from the latest non-field/cutscene route and re-prove/confirm the `loader-control-left200x2` boundary with `CleanAfterField`; do not add diagonal movement or HLE/GPU fast mode.
