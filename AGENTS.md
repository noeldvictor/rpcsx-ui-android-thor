...
- Current refiner/atlas next action: do not repeat field counterproof or verifier/hash/native-contract reports. Re-prove the clean loader-control-left200x2 boundary with `CleanAfterField` before adding battle movement again; body/skip/GPU modes remain blocked until field, Options/menu, and first-battle visuals are valid.
