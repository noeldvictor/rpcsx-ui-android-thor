...
- Current refiner/atlas next action: do not repeat field counterproof or diagonal field triage. Repair/prove first battle under `Verify25ccShadow` with body/skip/GPU modes off; lane-2 HLE/GPU dry-runs remain blocked until field, Options/menu, and first-battle visuals are valid.
