...
- Current refiner next action: repeated black-overlay blocker. Re-prove the newest clean `loader-control-left200x2` boundary with `CleanAfterField` before diagonal movement, first-battle work, or any HLE/GPU fast mode. Latest valid visual base remains `20260528-160536-cpu4-loader-control-left200x2-reconfirm-visualgate-windows-windows`.
