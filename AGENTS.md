...
- Current refiner/atlas next action: back off to the last clean `loader-control-left200x2` boundary and re-prove it with `CleanAfterField` before adding diagonal movement or any HLE/GPU fast mode.
