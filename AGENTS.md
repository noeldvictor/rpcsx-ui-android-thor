...
- Current refiner next action: extend the newest valid `loader-control-left200x2` route by exactly one tiny diagonal micro-pulse with `CleanAfterField`; keep lane-2 HLE/GPU fast modes blocked.
