...
- Current refiner/atlas next action: extend the newest valid loader-control-left200x2 route by exactly one tiny diagonal micro-pulse with `CleanAfterField`; keep lane-2 HLE/GPU dry-runs blocked until field, Options/menu, and first-battle visuals are valid.
