...
- Current refiner next action: use the newest valid loader-control as the route base, then add one small state-aware `left200` movement step with `CleanAfterField`; keep lane-2 HLE/GPU dry-runs blocked.
